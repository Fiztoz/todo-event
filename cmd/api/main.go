...
func main() {
	...
	readerHandler := taskadapter.NewReaderHandler(taskRepo)
	bus.Subscribe(taskdomain.EventCreated, readerHandler)
	bus.Subscribe(taskdomain.EventStatusChanged, readerHandler)
