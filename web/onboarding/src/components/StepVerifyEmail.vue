<template>
  <div class="step-card">
    ...
    <div class="card-desc">Check the welcome service logs for your verification token.</div>

    <div class="info-row">
      Check <code>cmd/welcome</code> logs — the token was printed when you registered.
    </div>
